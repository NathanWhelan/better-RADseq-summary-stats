...
# =============================================================================
work_dir    <- "~/snails/L_virgata/population-genomics/post-submission-filtering/virgata_m3M3n3_r80p11_maf025_gt6"
...
popmap_file <- "popmap_virgata.txt"     # two columns, NO header: sample_id <tab> population
